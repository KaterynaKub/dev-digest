...
/** Grid template for both the header row and PR rows. Track order must stay in
 *  lockstep with COLUMN_KEYS and with the cells PRRow renders positionally. */
export const GRID = "1fr 124px 92px 60px 100px 118px 88px 78px";
