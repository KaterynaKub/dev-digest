...
flowchart TD
  ...
  SKILLS["/skills<br/>library + preview"] --> SKILL["/skills/:id<br/>editor"]
  SETTINGS["/settings/:section<br/>API keys · models"]

  PULLS -->|"GET /repos/:id/pulls · /repos/:id/index-state"| API
  PR -->|"GET /pulls/:id · /reviews · /pulls/:id/comments<br/>POST /pulls/:id/review · /findings/:id/(accept|dismiss)"| API
  AGENTS -->|"/agents · /agents/:id · /agents/:id/skills · /agents/skill-counts"| API
  SKILLS -->|"/skills · /skills/:id · /skills/:id/versions · /skills/import/preview"| API
